...
public class PlayerStats : MonoBehaviour, IDamageable
{
    ...
    /// </summary>
    public void Damage(float _damage, Vector3 collisionPoint)
    {
    ...
    private void ManageFallDamage()
    {
        ...
        if(player.grounded && height != null && transform.position.y < height)
        {
            ...
            if (heightDifference > minimumHeightDifferenceToApplyDamage) Damage(heightDifference * fallDamageMultiplier, Vector3.zero);
